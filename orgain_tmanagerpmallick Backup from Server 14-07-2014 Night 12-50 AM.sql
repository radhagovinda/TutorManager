...
--
-- Host: localhost
-- Generation Time: Jul 14, 2014 at 12:49 AM
...
(131, NULL, 4, 'pradip', '', 'mallick', '', 'Male', NULL, '', '', '9434611009', '', '', '', NULL, '2013-07-10', 'Yes');
...
CREATE TABLE IF NOT EXISTS `student_attendance` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `StudentID` (`StudentID`,`ClassID`,`SubjectID`,`Date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
